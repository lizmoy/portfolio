    ...
    <div className="projects-container" id="projects">
        ...
        <div className="projects">
            <div className="row1">
                ...
                <a className="project-text-link" href="https://lizmoy.github.io/popaholic/" target="blank"><img src={popaholic} alt="" className="project"/></a>
                ...
                <div className="project-div">
                <a className="project-text-link" href="https://lm-modern-lexicon.herokuapp.com/" target="blank"><img src={lexicon} alt="" className="project"/></a>
                    <div className="project-text">
            ...
            <div className="row2">
                <div className="project-div">
                <a className="project-text-link" href="https://iterator.surge.sh/" target="blank"><img src={iterator} alt="" className="project"/></a>   
                    <div className="project-text">
                ...
                <div className="project-div">
                <a className="project-text-link" href="https://plantly.surge.sh/" target="blank"><img src={plantly} alt="" className="project"/></a>
                    <div className="project-text">
